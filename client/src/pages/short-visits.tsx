      ...
      <section className="relative overflow-hidden" style={{ background: `linear-gradient(135deg, ${NAVY} 0%, ${BLUE} 100%)` }}>
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8 py-20 sm:py-28">
          ...
          <div className="grid lg:grid-cols-[1fr_400px] gap-12 xl:gap-20 items-center">
            <div>
              <div className="inline-flex items-center px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-5 text-white/80" style={{ backgroundColor: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.15)" }}>
                Home Care
              </div>
              <h1 className="text-5xl sm:text-6xl font-extrabold text-white mb-3 tracking-tight leading-[1.05]">Short Visits</h1>
              <div className="mb-6" style={{ ...SCRIPT, fontSize: "clamp(1.8rem, 3.5vw, 2.8rem)", color: PINK }}>care when it counts.</div>
              <p className="text-white/70 text-lg max-w-xl leading-relaxed mb-10">Regular care visits throughout the day — helping you stay independent and comfortable in the home you love, without needing to move.</p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href="tel:03301658880" className="inline-flex items-center justify-center gap-2 px-7 py-4 font-semibold rounded-2xl text-white hover:bg-white/10 transition-all text-base" style={{ border: "2px solid rgba(255,255,255,0.2)" }}>
