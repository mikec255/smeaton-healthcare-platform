...
import { Clock, Users, Shield, CheckCircle, ArrowRight, Phone, Heart, Home, Activity, Stethoscope, Pill, HandHeart, Clock as TickerClock, Star as TickerStar} from "lucide-react";
    ...
    <div data-testid="short-visits-page">
      ...
      <section className="relative overflow-hidden" style={{ backgroundColor: CREAM }}>
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8 pt-8 pb-20 sm:pt-10 sm:pb-28">
          ...
          <div className="grid lg:grid-cols-[1fr_400px] gap-12 xl:gap-20 items-center">
            <div>
              <div className="inline-flex items-center px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-5 " style={{ color: BLUE, backgroundColor: "rgba(39,87,153,0.09)", border: "1px solid rgba(39,87,153,0.22)" }}>
                Home Care
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href="tel:03301658880" className="inline-flex items-center justify-center gap-2 px-7 py-4 font-semibold rounded-2xl hover:opacity-80 transition-all text-base" style={{ color: BLUE, border: "2px solid rgba(39,87,153,0.35)" }}>
      ...
      <section className="bg-white py-16 sm:py-20">
        <div className="max-w-3xl mx-auto px-5 sm:px-8 text-center">
          <h2 className="text-3xl font-extrabold mb-2 tracking-tight" style={{ color: NAVY }}>Ready to get started?</h2>
