    ...
    <div data-testid="enablements-page">
      <section style={{ backgroundColor: NAVY }} className="relative py-16 sm:py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold text-white mb-2 tracking-tight">Enabling</h1>
          <h1 className="mb-6" style={{ ...SCRIPT, fontSize: "clamp(2rem, 4vw, 3rem)", color: PINK }}>building your independence.</h1>
          <p className="text-white/60 text-lg max-w-2xl leading-relaxed">Build skills, confidence, and independence through personalised support that empowers you to achieve your goals and live life to the fullest.</p>
      ...
      <section style={{ backgroundColor: NAVY }} className="py-16 sm:py-20">
        <div className="max-w-3xl mx-auto px-5 sm:px-8 text-center">
          ...
          <div className="mb-5" style={{ ...SCRIPT, fontSize: "clamp(1.8rem,3.5vw,2.8rem)", color: "rgba(239,42,134,0.9)" }}>Let's talk about your goals.</div>
