        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8 py-20 sm:py-28">
          ...
          <div className="grid lg:grid-cols-[1fr_400px] gap-12 xl:gap-20 items-center">
            <div>
              ...
              <h1 className="text-5xl sm:text-6xl font-extrabold text-white mb-3 tracking-tight leading-[1.05]">Live-In Care</h1>
              <div className="mb-6" style={{ ...SCRIPT, fontSize: "clamp(1.8rem, 3.5vw, 2.8rem)", color: PINK }}>home is where you belong.</div>
              <p className="text-white/70 text-lg max-w-xl leading-relaxed mb-10">Full-time live-in support for people who need constant companionship and care, without leaving the home they love.</p>
