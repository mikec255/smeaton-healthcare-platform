    ...
    <div data-testid="condition-led-care-page">
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8 pt-8 pb-20 sm:pt-10 sm:pb-28">
          ...
          <div className="grid lg:grid-cols-[1fr_400px] gap-12 xl:gap-20 items-center">
            <div>
              ...
              <h1 className="text-5xl sm:text-6xl font-extrabold mb-3 tracking-tight leading-[1.05]" style={{ color: NAVY }}>Condition-Led Care</h1>
      ...
      <section className="py-16 sm:py-20" style={{ backgroundColor: "rgba(39,87,153,0.04)" }}>
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          ...
          <div className="rounded-2xl p-7 border border-gray-100 border-l-4" style={{ borderLeftColor: BLUE }}>
