  ...
  return (
    <div data-testid="about-page">
      ...
      <section className="relative overflow-hidden bg-white">
        <div className="absolute left-0 top-0 bottom-0 w-1.5" style={{ backgroundColor: PINK }} />
        <div className="max-w-7xl mx-auto px-5 sm:px-8 pt-14 pb-14">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <p className="text-xs font-bold tracking-widest uppercase mb-5" style={{ color: PINK }}>Our story</p>
            <h1 className="text-4xl sm:text-5xl font-extrabold mb-1 leading-tight tracking-tight" style={{ color: NAVY }}>Built on one</h1>
            <div className="mb-5" style={{ ...SCRIPT, fontSize: "clamp(2.5rem, 5.5vw, 4rem)", color: PINK }}>simple belief.</div>
      ...
      {/* CTA */}
      <section style={{ backgroundColor: BLUE }} className="relative overflow-hidden py-20 sm:py-24">
