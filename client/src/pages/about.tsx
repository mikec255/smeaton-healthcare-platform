          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <FadeIn>
              <div className="space-y-5 text-gray-500 leading-relaxed text-base">
                <p>Smeaton Healthcare was founded by Michael and Benjamin Wakefield-O'Connor, who both spent years working on the frontline of social care. They weren't investors or entrepreneurs who spotted a gap in the market. They were carers. They knew what good care looked like from the inside, and they also knew what happened when it fell short.</p>
