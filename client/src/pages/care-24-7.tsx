...
import { Clock, Users, Shield, CheckCircle, ArrowRight, Phone, Mail, Heart, Stethoscope, Activity, Pill, Thermometer, Eye, AlertCircle, UserCheck, HeartHandshake, Clipboard, Building2, PoundSterling, FileText, HelpCircle, Info } from "lucide-react";

export default function Care247() {
  const whatsIncluded = [
    {
      category: "Round-the-Clock Care",
      items: [
        "Carers available to you 24/7",
        "Night-time monitoring and support",
    ...
    },
    {
      ...
      items: [
        "Assistance with all personal hygiene needs",
  ...
  const benefits = [
    {
      ...
      description: "Round-the-clock care ensures immediate assistance is always available when needed"
    },
    {
      icon: Shield,
      title: "Safety & Security",
      description: "Continuous monitoring and professional oversight provide peace of mind for families"
    },
    {
      icon: Heart,
      title: "Personalised Care",
      description: "Individualised care plans adapted to specific needs, preferences, and medical requirements"
    },
    {
      icon: Users,
      title: "Family Relief",
      description: "Relief for family caregivers while ensuring your loved one receives expert care"
    }
  ];

  const faqs = [
    {
      question: "How is 24/7 care different from other care options?",
      answer: "24/7 care provides continuous presence of qualified care staff in your home, ensuring immediate assistance is available at any time of day or night. This differs from visiting care where staff come and go at set times."
    },
    {
      question: "What qualifications do the 24/7 care staff have?",
      answer: "All our 24/7 care staff are fully qualified healthcare professionals with relevant certifications, DBS checks, and ongoing training. Many have specialised experience in areas like dementia care, complex medical needs, or disability support."
    },
    {
      question: "Can family members still be involved in care?",
      answer: "Absolutely. We encourage family involvement and work closely with relatives to ensure continuity of care and emotional support. Families can visit any time and participate in care planning decisions."
    },
    {
      question: "How do you handle medical emergencies?",
      answer: "Our staff are trained in emergency procedures and first aid. We maintain direct communication with healthcare providers and emergency services, ensuring rapid response to any medical situation."
    },
    {
      question: "Is 24/7 care available for temporary periods?",
      answer: "Yes, we provide 24/7 care for both long-term needs and temporary situations such as post-hospital recovery, respite care, or during family holidays. We can arrange care starting immediately when needed."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        ...
        {/* Medical & Care Icon Patterns - Hidden on mobile for better performance */}
        <div className="absolute inset-0 opacity-10 pointer-events-none hidden md:block">
          {/* Top Row - Medical Equipment themed */}
          <Stethoscope className="absolute top-16 left-[8%] w-8 h-8 text-white animate-[rollInLeft_5s_ease-out_forwards]" />
          <Activity className="absolute top-20 left-[25%] w-6 h-6 text-white rotate-12 animate-[rollInTop_5s_ease-out_forwards]" style={{ animationDelay: '0.2s' }} />
          ...
          <Clock className="absolute top-16 left-[75%] w-6 h-6 text-white animate-[rollInRight_5s_ease-out_forwards]" style={{ animationDelay: '0.8s' }} />
          ...
          {/* Upper-Mid Row - Monitoring & Safety */}
          ...
          <AlertCircle className="absolute top-[35%] left-[50%] w-6 h-6 text-white animate-[rollInTop_5s_ease-out_forwards]" style={{ animationDelay: '0.9s' }} />
          ...
          {/* Middle Row - Care & Professional Support */}
          ...
          {/* Lower-Mid Row - Care Support */}
          <HeartHandshake className="absolute top-[68%] left-[18%] w-6 h-6 text-white animate-[rollInBottom_5s_ease-out_forwards]" style={{ animationDelay: '2.2s' }} />
          ...
          <AlertCircle className="absolute top-[86%] left-[78%] w-8 h-8 text-white animate-[rollInBottom_5s_ease-out_forwards]" style={{ animationDelay: '1.6s' }} />
          ...
          <HeartHandshake className="absolute top-[64%] left-[97%] w-5 h-5 text-white animate-[rollInRight_5s_ease-out_forwards]" style={{ animationDelay: '2.7s' }} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-black text-white mb-6 leading-tight" data-testid="hero-title">
                <span className="block">24/7 Care</span>
              </h1>
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 mb-8 leading-relaxed font-medium" data-testid="hero-description">
                Round-the-clock professional care and support for those who need continuous assistance.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/referral" data-testid="hero-cta-primary">
                  <Button size="lg" className="bg-secondary text-white hover:bg-secondary/90 hover:scale-105 transition-all duration-300 shadow-xl font-semibold text-lg px-8 py-4">
                    Discuss Your Needs
              ...
              <div className="relative">
                  ...
                  <CardContent className="p-0">
                    <div className="text-center space-y-4">
                      <div className="space-y-1">
                        ...
                        <div className="text-muted-foreground font-semibold text-sm">Round-the-clock care</div>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="text-muted-foreground font-semibold text-sm">Every day of the year</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="absolute -top-12 -left-12 p-6 bg-secondary text-white shadow-xl border-0 rotate-3 hover:rotate-0 transition-transform duration-300">
                  <div className="text-center">
                    ...
                    <div className="text-base opacity-90">Care Staff</div>
                  </div>
                </Card>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4" data-testid="whats-included-title">
              Comprehensive 24/7 Care Services
            </h2>
            <p className="text-xl text-muted-foreground" data-testid="whats-included-subtitle">
              Complete care coverage ensuring comfort, safety, and wellbeing around the clock
            </p>
          </div>

          <Tabs defaultValue="Round-the-Clock Care" className="w-full" data-testid="service-tabs">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto" data-testid="who-its-for-subtitle">
              Round-the-clock care is designed for individuals with complex needs requiring constant support and supervision
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              "Individuals with advanced dementia requiring constant supervision and support",
              "People with complex medical conditions needing continuous monitoring and care",
              "Those recovering from major surgery or serious illness requiring intensive support",
              "Individuals with severe disabilities needing assistance with all daily activities",
              "People at risk of falls or medical emergencies who need immediate assistance available",
              "Family caregivers who need respite while ensuring their loved one receives expert care"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground" data-testid="benefits-subtitle">
              Continuous professional care that provides security, comfort, and peace of mind
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground" data-testid="faqs-subtitle">
              Understanding our comprehensive 24/7 care service
            </p>
          </div>
