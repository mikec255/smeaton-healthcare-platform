    ...
    <div data-testid="costings-page">
      ...
      <section style={{ backgroundColor: PINK }} className="py-14">
        <div className="max-w-3xl mx-auto px-5 sm:px-8 text-center">
          ...
          <div className="mb-5" style={{ ...SCRIPT, fontSize: "clamp(1.8rem, 3.5vw, 2.8rem)", color: "rgba(255,255,255,0.9)" }}>We're here to help.</div>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="https://www.citizensadvice.org.uk/" target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-6 py-3.5 font-semibold rounded-xl text-white hover:bg-white/10 transition-all border-2" style={{ borderColor: "rgba(255,255,255,0.3)" }} data-testid="citizens-advice-button">
